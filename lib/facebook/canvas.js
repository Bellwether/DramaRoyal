...
function receiveSignedRequest(req, res, appSecret){
  // heather
  // localhost:3000/games?signed_request=eA3joe9mvMWWAkzKN0gFSNl5lKezHhlOqEgDGDUZLJg.	
  // sophia
  // localhost:3000/games?signed_request=Lry-l5gSzwFHH1kaZ213dilbwqJ_o7wQU_k_8IikRwg.
  // vag
  // localhost:3000/games?signed_request=Ju2dAn3apZiKfB7_bMA5gPWs3FyjydJ3GqUjQ2n_uT4.
...
console.log("isValidSignature && hasToken "+isValidSignature+" "+hasToken+" "+JSON.stringify(jsonData))
  if (isValidSignature && hasToken) {
	...
	console.log(res.facebookSession.token())
  }
}
