...
console.log("auth++ beginNewUserSession findOrCreateFromFacebook "+JSON.stringify(doc)+" err was "+err)
...
function requireUser(req, res, callback) {
  console.log("auth++ requireUser session "+JSON.stringify(req.session))
